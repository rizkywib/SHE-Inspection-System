    ...
    <div id="app" class="flex min-h-screen">
        ...
        <aside class="sidebar-gradient text-white w-64 hidden md:flex md:flex-col shadow-xl">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2">
                ...
                <a href="/dashboard/fire-extinguishers" class="nav-link flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-white hover:bg-opacity-10 @yield('nav-fire-extinguishers', '')">
                ...
                <a href="/dashboard/users" class="nav-link flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-white hover:bg-opacity-10 @yield('nav-users', '')">
